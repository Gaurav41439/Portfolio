          ...
          <div className="header-inner d-flex align-items-center">
            ...
            <div className="about-social text-center">
              <ul>
                ...
                <li><Link to="https://www.linkedin.com/in/gaurav23bisht/"><i><RiLinkedinFill size={20} /></i></Link></li>
                <li><Link to="https://github.com/Gaurav41439"><i><RiGithubLine size={20} /></i></Link></li>
              </ul>
            </div>
          </div>
        </div>
