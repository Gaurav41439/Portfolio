                ...
                <div className="container-inner">
                    ...
                    <div className="row">
                        <div className="col-xl-10">
                            ...
                            <Card year={"Jan 2025 - Present"} title={"@ Indian Institute of Technology"} institution={"Research Intern"} description={"Research Intern at IIT Bombay, KCDH Department. Responsible for data collection, cleaning, and analysis to support ongoing research projects. Gained hands-on experience with data handling, preprocessing, and applying data-driven insights for research advancement."} />
                            <Card year={"Aug 2024 - Present"} title={"@ RAIT ACM Student Chapter"} institution={"Technical Chief"} description={"As the Technical Chief at the RAIT ACM Student Chapter, I lead and coordinate technical initiatives, workshops, and events that foster skill development and knowledge sharing among students. My role involves managing technical projects, organizing coding competitions, and facilitating guest lectures and training sessions to enhance our members' expertise in emerging technologies and industry practices."} />
                                <Card year={"Jul 2024 - Nov 2024"} title={"@ Sensix Tech Pvt. Ltd."} institution={"Python Developer Intern"} description={"As a Python Developer Intern at Sensix Tech Pvt. Ltd., I worked on developing and optimizing Python-based applications, contributing to various projects by writing efficient code and implementing features. My responsibilities included debugging, testing, and collaborating with the team to ensure seamless integration and performance of software solutions. This role allowed me to apply my programming skills in a practical environment while gaining valuable industry experience."} />
